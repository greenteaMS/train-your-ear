...
public abstract class AbstractTaskPaneController extends AbstractController
	...
	PseudoClass correct = PseudoClass.getPseudoClass("correctAnswerCell");
	PseudoClass wrong = PseudoClass.getPseudoClass("wrongAnswerCell");
            ...
            return new ListCell<String>() {
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty || item == null) {
                        ...
                        System.out.println("item " + item + " " + correct + " " + wrong);
