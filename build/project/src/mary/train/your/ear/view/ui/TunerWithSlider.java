...
public class TunerWithSlider extends VBox {
	...
	public void checkAnswer() {
		double newFrequency = getCurrentFrequency();
		System.out.println("newFrequency: " + newFrequency + "; correct: " + element.getCorrectFreq());
	...
	public void showAnswer() {
		double newFrequency = getCurrentFrequency();
		result.setText(StringConstants.ERROR_COLON + (element.getCorrectFreq() - newFrequency) + StringConstants.SPACE_HZ);
	}
